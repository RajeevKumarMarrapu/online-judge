...
LANGUAGE_CODE = 'en-US'
DEFAULT_USER_TIME_ZONE = 'Asia/Kolkata'
USE_I18N = True
USE_L10N = True
USE_TZ = True
...
SITE_NAME = 'Coding Maxima'
SITE_LONG_NAME = 'Coding Maxima: Modern Online Judge'
SITE_ADMIN_EMAIL = 'admin@example.com'
TERMS_OF_SERVICE_URL = '//localhost:80/tos' # Use a flatpage.
